...
# ---------------- EC2 instance role ----------------
# Lets EC2 instances read DB credentials from SSM, use Session Manager
# (no SSH keys needed), and write logs/metrics to CloudWatch.
...
resource "aws_iam_role_policy" "ec2_ssm_read_params" {
  name = "${local.name_prefix}-ec2-ssm-read"
