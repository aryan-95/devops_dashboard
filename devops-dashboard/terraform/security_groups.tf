# =========================================================
# Security Groups - enforce: Internet -> ALB -> EC2 -> RDS only
# =========================================================
...
resource "aws_security_group" "app" {
  ...
  description = "Allow application traffic ONLY from the ALB, and SSH for admin (optional)"
  vpc_id      = aws_vpc.main.id
  ...
  egress {
    description = "All outbound (package installs, SSM, RDS)"
    from_port   = 0
    to_port     = 0
    protocol    = "-1"
    cidr_blocks = ["0.0.0.0/0"]
